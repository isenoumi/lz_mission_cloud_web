  ...
  <div :class="{ fullscreen: fullscreen }" class="tinymce-container" :style="{ width: containerWidth }">
    ...
    <div class="editor-custom-btn-container">
      <el-upload
        class="upload-demo"
        list-type="picture"
        :action="$httpShop.adornUrl('/admin/file/upload/element')"
...
import Editor from '@tinymce/tinymce-vue' //编辑器组件
// import 'tinymce/themes/silver/theme'
// import 'tinymce/icons/default/icons'
// import 'tinymce/models/dom/model'
// import 'tinymce/plugins/wordcount/plugin'
// import '../../../public/tinymce/plugins/wordlimit'
import '../../../public/tinymce/langs/zh_CN.js' //汉化包
import '../../../public/tinymce/skins/ui/oxide/skin.min.css' //tinymce主题（不引入页面不会显示）

// import tinymceJs from './tinymce'
// import './tinymce'
...
export default {
  ...
  methods: {
      ...
      load(resourceCdn1, (err) => {
        ...
        load(resourceCdn2, (err2) => {
          ...
          load(resourceCdn3, (err3) => {
            ...
            this.$messageE.error(err.message)
          })
        })
      })
      // load(tinymceJs)
    ...
    beforeAvatarUpload(file) {
      ...
      if (!isLt2M) {
        this.$messageE.error('上传图片大小不能超过 2MB!')
      }
      return isLt2M && isJPG
    },
    imageSuccessCBK(response, file, fileList) {
      ...
      fileList.forEach((v) => {
        window.tinymce
          .get(_this.tinymceId)
          .insertContent(`<img class="wscnph" src="${this.resourcesUrl + v.response}" >`)
      })
    },
  },
}
