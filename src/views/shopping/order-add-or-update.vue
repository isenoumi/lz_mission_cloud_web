      ...
      <div class="content">
          ...
          <div class="num-cont">
            ...
            <div class="steps">
              <el-steps :active="2" align-center>
                ...
                <el-step title="待发货" description="2018/11/2 18:06:22"></el-step>
                <el-step title="已发货" description="2018/11/2 18:06:22"></el-step>
                <el-step title="已完成" description="2018/11/2 18:06:22"></el-step>
              </el-steps>
            </div>
          </div>
        </div>
        ...
        <div class="order-state">
          <div class="state-cont">
                ...
                <div class="detail-cont">
                  <div class="detail01">
                    ...
                    <div class="text-width">
                      <span>配送方式：快递发货</span>
                      <span class="revise-addr" onclick="window.location.href='#'"
                        ><img src="~@/assets/img/revise.png" alt="" />修改地址</span
                      >
                      <br />
              ...
              <div class="buyers">
                ...
                <div class="buyers-info">
                  <div class="detail02">
                    ...
                    <div class="text-width">
                      <span>买家备注：</span>
                      <span class="revise-remarks" onclick="window.location.href='#'"
                        ><img src="~@/assets/img/revise.png" alt="" />修改备注</span
                      >
                      <br />
                      <span
                        >给我加多点香菜香菜香菜香菜香菜香菜香菜香菜香菜香菜香菜香菜香菜香菜香菜香菜香菜香菜香菜香菜香菜香菜香菜</span
                      ><br />
                    </div>
                  </div>
                  <div class="detail02">
            ...
            <!-- 价格详情 -->
            <div class="item-info">
              <span>商品总价：<span class="text">￥15.00</span></span
              ><br />
              <span>店铺优惠：<span class="text">-￥0.00</span></span
              ><br />
              <span>积分抵扣：<span class="text">-￥0.00</span></span
              ><br />
              <span>发票费用：<span class="text">￥0.00</span></span
              ><br />
              <span>配送费用：<span class="text">￥0.00</span></span
              ><br />
