<template>
  ...
  >
            ...
            <div class="num-cont">
              ...
              <el-form-item>
                <el-steps :active="stepsStatus" align-center :process-status="dataForm.status == 6 ? 'error' : 'wait'">
                  ...
                  <el-step title="提交订单" :description="dataForm.payTime"></el-step>
                  <el-step title="待发货" :description="dataForm.payTime"></el-step>
                  <el-step title="已发货" v-if="dataForm.orderType !== 1" :description="dataForm.dvyTime"></el-step>
                  <el-step title="已完成" v-if="dataForm.orderType !== 1" :description="dataForm.finallyTime"></el-step>
                </el-steps>
              </el-form-item>
            </div>
          </div>
            ...
            <div class="state-cont">
              <div class="state-title">
                <el-form-item label="订单状态:">
                  <template slot-scope="scope">
                    ...
                    <el-tag v-if="dataForm.status === 0" size="small" type="warning">待发货</el-tag>
                    <el-tag v-if="dataForm.status === 1" size="small" type="warning">已发货</el-tag>
                    <!-- <el-tag v-if="dataForm.status === 4 && dataForm.orderType !== 1" size="small" type="warning"
                      >待评价</el-tag
                    > -->
                    <el-tag v-if="dataForm.status === 2" size="small" type="success">已完成</el-tag>
                ...
                <el-form-item>
                  <el-row>
                    ...
                    <el-button
                      ...
                      plain
                      @click="changeEdit(dataForm.orderNumber)"
                    >
                      修改发货信息
                    </el-button>
                    <!--      v-if="dataForm.status === 1 && dataForm.orderType !== 1"  -->
                      ...
                      <div class="text-width">
                        ...
                        <el-form-item label="收货地址: ">
                          <span
                            ...
                            }}{{ dataForm.userAddrOrder.area }}{{ dataForm.userAddrOrder.addr }}</span
                          >
                        </el-form-item>
                      </div>
                    </div>
              ...
              <div class="item-list">
                <el-table :data="dataForm.orderItems" border>
                  ...
                  <!-- <el-table-column prop="price" label="兑换积分" width="180" align="center">
                    <template slot-scope="scope">
                      <span>{{ scope.row.price }}</span>
                    </template>
                  </el-table-column> -->
                  <el-table-column prop="points" label="兑换积分" width="180" align="center">
                    <template slot-scope="scope">
                  ...
                  <el-table-column prop="count" label="数量" width="180" align="center">
                    <template slot-scope="scope">
                      ...
                      <span>{{ dataForm.productNums }}</span>
                    </template>
                  </el-table-column>
                  <!-- <el-table-column prop="totalPrice" label="订单合计积分" width="180" align="center">
                    <template slot-scope="scope">
              ...
              <div class="item-info">
                <!-- <el-form-item label="商品总价:">
                  <span class="text">{{ dataForm.total }} 分</span>
                </el-form-item> -->
                ...
                <!-- <el-form-item label="应付积分:">
                  <span class="text">{{ dataForm.actualTotal }} 分</span>
                </el-form-item> -->
              </div>
            </div>
          </div>
          <div class="order-log">
            ...
            <div class="log-cont">
              ...
              <el-form-item v-if="dataForm.payTime" label-width="10px">
                ...
                <span>{{ dataForm.payTime }} {{ dataForm.nickName }} 创建订单（成功）</span>
              </el-form-item>
              ...
              <el-form-item v-if="dataForm.payTime" label-width="10px">
                ...
                <span>{{ dataForm.payTime }} {{ dataForm.nickName }} 订单兑换（成功）</span>
              </el-form-item>
    ...
    <order-edit v-if="editVisible" ref="editAdd" @refreshDataList="getDataList"></order-edit>
  </el-dialog>
</template>
