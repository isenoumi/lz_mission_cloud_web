<template>
  <el-dialog :modal="false" title="选择发货信息" :close-on-click-modal="false" :visible.sync="visible" width="30%">
    <el-form
      :model="dataForm"
      :rules="dataRule"
      ref="dataForm"
...
export default {
  ...
  methods: {
    init(orderNumber, dvyId, dvyFlowId, hasDummy) {
      console.log('orderNumber, dvyId, dvyFlowId', orderNumber, dvyId, dvyFlowId, hasDummy)
      this.visible = true
