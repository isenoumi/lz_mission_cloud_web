          ...
          <a-col :span='24' @click='initDictConfig'>
            <a-form-model-item label='关联知识库' :labelCol='labelCol' :wrapperCol='wrapperCol' prop='knowledgeId'>
              <j-search-select-tag :dictOptions='searchOptions' type='select' v-model='model.knowledgeId'
                                 placeholder='请选择关联知识库' @change='knowTypeChange()' />
            </a-form-model-item>
          </a-col>
          <!--          <a-col :span="24">-->
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        add: '/mission/bkbChoiceqst/add',
        edit: '/mission/bkbChoiceqst/edit',
        queryById: '/mission/bkbChoiceqst/queryById',
        bkbChoiceqstAnswer: {
          list: '/mission/bkbChoiceqst/queryBkpChoiceqstAnswerByMainId'
        }
      }
    }
  },
