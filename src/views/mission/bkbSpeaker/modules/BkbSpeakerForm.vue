  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="演讲员名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="name">
              <a-input v-model="model.name" placeholder="请输入演讲员名称"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="演讲员电话" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="phone">
              <a-input v-model="model.phone" placeholder="请输入演讲员电话"  ></a-input>
            </a-form-model-item>
          </a-col>
...
export default {
    ...
    data () {
      return {
        ...
        validatorRules: {
           name: [
              { required: true, message: '请输入演讲员名称!'},
           ],
           phone: [
              { required: true, message: '请输入演讲员电话!'},
        ...
        url: {
          add: "/mission/bkbSpeaker/add",
          edit: "/mission/bkbSpeaker/edit",
          queryById: "/mission/bkbSpeaker/queryById"
        }
      }
    },
    computed: {
