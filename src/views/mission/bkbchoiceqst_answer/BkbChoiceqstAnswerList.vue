  ...
  <a-card :bordered='false'>
          ...
          <template v-if='toggleSearchStatus'>
            ...
            <a-col :xl='6' :lg='7' :md='8' :sm='24'>
              <a-form-item label='题型'>
                <j-dict-select-tag placeholder='请选择单选还是多选题' v-model='queryParam.choiceType'
                                   dictCode='answer_type' />
              </a-form-item>
            </a-col>
            <a-col :xl='6' :lg='7' :md='8' :sm='24'>
    ...
    <div class='table-operator'>
      ...
      <a-upload name='file' :showUploadList='false' :multiple='false' :headers='tokenHeader' :action='importExcelUrl'
                @change='handleImportExcel2'>
        <a-button type='primary' icon='import'>导入</a-button>
      </a-upload>
      <a-button type='primary' href='/static/答题题库模板示例.xlsx' icon='download'>模板文件下载</a-button>
      <!-- 高级查询区域 -->
    ...
    <bkp-choiceqst-answer-modal ref='modalForm' @ok='modalFormOk' />
    <!--    // 查看模态框-->
    <a-modal
      title='查看'
...
import BkpChoiceqstView from './modules/BkbChoiceqstAnswerView'
import Area from '@comp/_util/Area'
import '@assets/less/TableExpand.less'
import { getAction } from '@api/manage'
import Vue from 'vue'
import { USER_INFO } from '@/store/mutation-types'
import BkpChoiceqstAnswerModal from '@views/mission/bkbchoiceqst_answer/modules/BkpChoiceqstAnswerModal'

export default {
  name: 'BkpChoiceqstAnswerList',
  mixins: [JeecgListMixin],
  components: {
    BkpChoiceqstView,
    BkpChoiceqstAnswerModal
  },
  data() {
    return {
      ...
      url: {
        list: '/mission/bkbChoiceqst_answer/list',
        exportXlsUrl: '/mission/bkbChoiceqst_answer/exportXls',

        delete: '/mission/bkbChoiceqst_answer/delete',
        deleteBatch: '/mission/bkbChoiceqst_answer/deleteBatch',
        importExcelUrl: 'mission/bkbChoiceqst_answer/importExcel',
        publish: '/mission/bkbChoiceqst_answer/publish',
        freeze: '/mission/bkbChoiceqst_answer/freeze',
        abandon: '/mission/bkbChoiceqst_answer/abandon'
      },
      superFieldList: []
    }
  },
  ...
  methods: {
    ...
    updateKnowledge() {
      ...
      getAction('/mission/bkbChoiceqst_answer/updatedata').then(res => {
      })
    ...
    getSuperFieldList() {
      ...
      fieldList.push({ type: 'int', value: 'choiceType', text: '单选还是多选题', dictCode: 'answer_type' })
