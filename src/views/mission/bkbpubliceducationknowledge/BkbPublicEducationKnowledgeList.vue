      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="关联知识库标题">
              <a-input placeholder="请输入关联知识库标题" v-model="queryParam.knowledgeTitle"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--      <a-button type="primary" icon="download" @click="handleExportXls('宣教关联知识库')">导出</a-button>-->
...
<!--      </a-upload>-->
    ...
    <bkb-public-education-knowledge-modal ref="modalForm" @ok="modalFormOk"></bkb-public-education-knowledge-modal>
    <!--    // 查看模态框-->
    <a-modal
      title="查看"
...
<script>
  ...
  import BkbPublicEducationKnowledgeModal from './modules/BkbPublicEducationKnowledgeModal'
  ...
  export default {
    name: 'BkbPublicEducationKnowledgeList',
    mixins:[JeecgListMixin, mixinDevice],
    components: {
      BkbPublicEducationKnowledgeModal,
      BkpKnowledgeView
    },
    data () {
      return {
        searchOptions:[],
        description: '宣教关联知识库管理页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/mission/bkbPublicEducationKnowledge/list",
          delete: "/mission/bkbPublicEducationKnowledge/delete",
          deleteBatch: "/mission/bkbPublicEducationKnowledge/deleteBatch",
          exportXlsUrl: "/mission/bkbPublicEducationKnowledge/exportXls",
          importExcelUrl: "mission/bkbPublicEducationKnowledge/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'knowledgeId',text:'关联知识库',dictCode:"bkb_knowledge,title,id"})
